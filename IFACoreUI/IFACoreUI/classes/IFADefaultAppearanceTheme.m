...
- (id)init{
    ...
    if (self) {
        ...
        self.barSegmentedControlAppearance = [UISegmentedControl appearanceWhenContainedInInstancesOfClasses:@[[UIToolbar class], [self navigationControllerClass]]];
        self.segmentedControlAppearance = [UISegmentedControl appearanceWhenContainedInInstancesOfClasses:@[[self navigationControllerClass]]];
        self.switchAppearance = [UISwitch appearanceWhenContainedInInstancesOfClasses:@[[self navigationControllerClass]]];
